...
$("#content").css("top","75%"),$(document).ready(function(){$("#fixed-container").css("position","fixed"),$("#fixed-container").addClass("fixed-container-box-shadow"),$("#menu-trigger").css("position","fixed"),$(".remove-active").removeClass("active"),$(".clients .h3, .locations .h3").addClass("visuallyhidden"),pigOnTop($(window).scrollTop()),sr.reveal(".box-container .box-image, .service .ps-article, .dt-box, .dd-box, .jumbotron .h1, .jumbotron p, .wrapper-body-contact .contact-box address, .wrapper-body-contact .contact-box dt, .wrapper-body-contact .contact-box dd")}),$(window).on("scroll",function(){pigOnTop($(window).scrollTop())}),$("#nav-menu a, .content section h1 > a, .content section h2 > a, h3 a").on("click",function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);if((n=n.length?n:$("[name="+this.hash.slice(1)+"]")).length)return scrollToTrigger(n),!1}}),$("#menu-trigger button").on("click",function(){menuAppear()}),$("#close-trigger button, #black-out").on("click",function(){menuDisappear()}),$(".big-nav-pills a").on("shown.bs.tab",function(n){sr.sync()});function scrollToTrigger(n){var e=15*$(window).height()/75,o=n.offset().top-e;$("html, body").scrollTop(o)}function pigOnTop(n){if(n<=0)var e=100;else e=15;$("#fixed-container").css("height",e+"%")}function menuAppear(){$("#menu-container").show(),$("#nav-menu .menu-list > li").removeClass("menu-list-disappear"),$("#menu-container").removeClass("menu-container-disappear"),$("#black-out").removeClass("visuallyhidden").addClass("black-out"),$("#close-trigger").removeClass("visuallyhidden"),$("#menu-container").addClass("focus").removeClass("visuallyhidden")}function menuDisappear(){$("#nav-menu .menu-list > li").addClass("menu-list-disappear"),$("#menu-container").addClass("menu-container-disappear"),$("#black-out").addClass("black-out-disappear"),setTimeout(function(){$("#black-out").addClass("visuallyhidden").removeClass("black-out black-out-disappear")},300),setTimeout(function(){$("#menu-container").removeClass("focus").addClass("visuallyhidden"),$("#close-trigger").addClass("visuallyhidden")},500)}
$(".popup-gallery").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-1").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-2").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-3").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-4").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-5").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-6").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-7").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-8").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-9").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-10").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-11").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-12").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-13").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-14").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}}),$(".popup-gallery-15").magnificPopup({delegate:"a",gallery:{enabled:!0},image:{titleSrc:null}});
$("#slick-carousel").slick({autoplay:!0,autoplaySpeed:3e3,dots:!0,arrows:!1,infinite:!0,slidesToShow:1,slidesToScroll:1});